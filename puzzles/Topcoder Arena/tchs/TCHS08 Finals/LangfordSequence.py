...
def do_test(a, __expected):
    startTime = time.time()
    instance = LangfordSequence()
    exception = None
    try:
        __result = instance.getFirst(a);
    except:
        import traceback
...
def run_tests():
    sys.stdout.write("LangfordSequence (250 Points)\n\n")
    ...
    with open("LangfordSequence.sample", "r") as f:
        while True:
            label = f.readline()
