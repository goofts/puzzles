...
// CUT begin
	public static void main(String[] args){
		System.err.println("GreaterThanAll (600 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1576917476;
	...
	static boolean doTest(int n, int k, int __expected) {
		...
		GreaterThanAll instance = new GreaterThanAll();
		int __result = 0;
		try {
	...
	static class Reader {
        private static final String dataFileName = "GreaterThanAll.sample";
